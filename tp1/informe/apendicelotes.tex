...
\lstinputlisting[caption="Lote de tests ejercicio 9", frame=single]{../codigo/experimentos/lote_edf2.tsk}
\lstinputlisting[caption="Lote de tests ejercicio 9", frame=single]{../codigo/experimentos/lote_edf2.tsk}
\lstinputlisting[caption="Lote de tests ejercicio 10", frame=single]{../codigo/lote_edf.tsk}
\lstinputlisting[caption="Lote de tests ejercicio 10", frame=single]{../codigo/lote_edf3.tsk}